...
def make_parser():
    ...
    parser.add_argument("--path", default="E:/track/dataset/MOT17Det/train/MOT17-02/img1", help="path to images or video")
    parser.add_argument("--camid", type=int, default=0, help="webcam demo camera id")
    parser.add_argument("--save_result", action="store_true",help="whether to save the inference result of image/video")
    parser.add_argument("--save_path",type=str,default=None,help="output video path; if not set and save_result is True, a default path under YOLOX_outputs will be used.",)
