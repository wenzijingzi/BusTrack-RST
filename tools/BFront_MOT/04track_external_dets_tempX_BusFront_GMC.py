...
RESULTS_ROOT = r"E:/track/BoT-SORT-main/YOLOX_outputs/1/m2la_botsort_tempX_busfront_OIP_scale"
...
def build_tracker(frame_rate=30, seq_name="BF_01"):
    ...
    # CMC（相机运动补偿） — 改成busfront ，后面你可以改"none"/ "orb" / "ecc"/"sparseOptFlow"
    args.cmc_method = "busfront"   #原来是none
